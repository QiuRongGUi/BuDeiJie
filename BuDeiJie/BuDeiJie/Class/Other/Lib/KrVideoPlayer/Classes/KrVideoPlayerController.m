...
- (void)configControlAction
{
    ...
    [self.videoControl.backButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
...
- (void)back{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"KRVideoBack" object:nil userInfo:nil];
